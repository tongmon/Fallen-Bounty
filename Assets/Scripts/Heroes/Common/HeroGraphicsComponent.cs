...
public class HeroGraphicsComponent : GraphicsComponent
{
    ...
    public HeroGraphicsComponent(GameObject gameobject) : base(gameobject)
    {
        ...
        //m_sprite_mask = ((Hero)m_data).transform.Find("RangerSpriteMask").GetComponent<SpriteMask>();//수정 필
        ...
        //m_main_sprite = ((Hero)m_data).transform.Find("RangerSprite").GetComponent<SpriteRenderer>();//수정 필
    }
